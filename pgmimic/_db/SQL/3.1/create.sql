...
/*
 * MIMIC-IV-ED schema and tables.
 *
 * The upstream MIMIC-IV-ED dataset has not moved to a 3.1 release;
 * its latest version is 2.2 (https://physionet.org/content/mimic-iv-ed/).
 * The DDL below is the 2.2 ED schema verbatim, copied from
 * pgmimic/_db/SQL/2.2/create.sql so that a single 3.1 import populates
 * both the MIMIC-IV 3.1 hosp/icu tables and the MIMIC-IV-ED 2.2 tables.
 */
